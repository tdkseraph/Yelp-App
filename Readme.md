...
**Yelp App** is a Yelp search app using the [Yelp API](https://www.yelp.com/developers/documentation/v3/business_search).
...
--Later--
<img src='https://media.giphy.com/media/3o7bu1iUEPZ2lRnwDm/giphy.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
